...
if __name__ == "__main__":
    # === Train base adapters ===
    class_1_9_adapter = train_clip_lora(first_class=1, last_class=9)
    ...
    test_clip_lora(first_class=1, last_class=20, adapter_path=class_1_9_adapter)
    ...
    base_adapter = class_1_9_adapter
