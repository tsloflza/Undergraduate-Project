...
if __name__ == "__main__":
    ...
    # === f10_p0 + s * f0_p10 ===
    base_adapter = f10_p0_adapter
    base_save_root = "output/addition/f10_p0"
    ...
    for s in np.arange(0, 1.01, 0.1):
        ...
        # New_Adapter = f10_p0 + s * f0_p10
        linear_arith(f10_p0_adapter, s, f0_p10_adapter, save_path)
    ...
    # === f0_p10 + s * f10_p0 ===
    base_adapter = f0_p10_adapter
    base_save_root = "output/addition/f0_p10"
    ...
    for s in np.arange(0, 1.01, 0.1):
        ...
        # New_Adapter = f0_p10 + s * f10_p0
        linear_arith(f0_p10_adapter, s, f10_p0_adapter, save_path)
        test_clip_lora(adapter_path=save_path, flowers_class=10, pets_class=10)
        print(f"Testing s={s:.2f} finish!")
