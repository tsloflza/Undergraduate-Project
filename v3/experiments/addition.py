...
if __name__ == "__main__":
    # === Train base models ===
    class_11_100_model = train_clip(first_class=11, last_class=100, num_per_class=500)
    class_1_10_model = train_clip(first_class=1, last_class=10, num_per_class=500, epoch=1, skip_first=True)

    test_clip(first_class=1, last_class=100, model_path=class_11_100_model)
    test_clip(first_class=1, last_class=100, model_path=class_1_10_model)

    base_model = class_11_100_model
    ...
    for s in np.arange(0, 2.01, 0.1):
        ...
        # New_model = class_11_100 + s * class_1_10
        task_vector(class_11_100_model, s, class_1_10_model, save_path)
